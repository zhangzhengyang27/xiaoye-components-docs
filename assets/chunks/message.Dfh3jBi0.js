...
function openGlobalMessage() {
  XyMessage("这条消息会继承当前 Config Provider 里的默认配置。");
}
<\/script>
...
<template>
  ...
  >
    <xy-space wrap>
      <xy-button type="primary" @click="openGlobalMessage"> 触发继承全局配置的消息 </xy-button>
      <xy-tag status="primary">
        placement / showClose / duration / grouping / max / closeOnClick 都来自 Config Provider
      </xy-tag>
    </xy-space>
  </xy-config-provider>
</template>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> openGlobalMessage</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">() {</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">  XyMessage</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"这条消息会继承当前 Config Provider 里的默认配置。"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">);</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">      closeOnClick: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF">true</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">        placement / showClose / duration / grouping / max / closeOnClick 都来自 Config Provider</span></span>
