...
function openInherited() {
  XyNotificationService.open({
    title: "继承 ConfigProvider.notification"
  });
}

function openOverridden() {
  XyNotificationService.open({
    title: "显式覆盖默认值",
    position: "top-right",
    showClose: true
...
<template>
  ...
  >
    <xy-space wrap>
      <xy-button type="primary" @click="openInherited">继承默认配置</xy-button>
      <xy-button plain @click="openOverridden">显式覆盖</xy-button>
      <xy-tag round status="primary">
        duration / position / showClose / max / overflowStrategy 来自 ConfigProvider
      </xy-tag>
    </xy-space>
  </xy-config-provider>
</template>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> openInherited</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">() {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    title: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"继承 ConfigProvider.notification"</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">  });</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> openOverridden</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">() {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">  XyNotificationService.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">open</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">({</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    title: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"显式覆盖默认值"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">      overflowStrategy: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">'drop-oldest'</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">        duration / position / showClose / max / overflowStrategy 来自 ConfigProvider</span></span>
