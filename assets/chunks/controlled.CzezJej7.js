...
<template>
  <div class="alert-demo-stack">
    <xy-space>
      <xy-button type="primary" @click="visible = true">重新打开提示</xy-button>
      <xy-button plain @click="visible = !visible">
        {{ visible ? "外部隐藏" : "外部显示" }}
      </xy-button>
    </xy-space>
    ...
    <xy-alert
      v-model="visible"
      title="当前提示由父组件控制显示状态"
      type="primary"
      description="点击关闭按钮或外部按钮时，都会通过 v-model 同步到同一份状态。"
      show-icon
    />
  </div>
</template>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">        {{ visible </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">?</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF"> "外部隐藏"</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583"> :</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF"> "外部显示"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8"> }}</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">      title</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"当前提示由父组件控制显示状态"</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">      description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"点击关闭按钮或外部按钮时，都会通过 v-model 同步到同一份状态。"</span></span>
