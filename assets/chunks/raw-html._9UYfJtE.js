...
function openHtmlMessage() {
  XyMessage({
    message: "<strong>发布成功</strong>，已把最新配置同步到预发环境。",
...
<template>
  <xy-button type="primary" @click="openHtmlMessage"> 使用 HTML 内容 </xy-button>
</template>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> openHtmlMessage</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">() {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    message: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"&#x3C;strong>发布成功&#x3C;/strong>，已把最新配置同步到预发环境。"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
