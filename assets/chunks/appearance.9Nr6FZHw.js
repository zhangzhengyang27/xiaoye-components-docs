...
function openPlainMessage() {
  XyMessage({
    message: "这是一条更轻的 plain 风格消息。",
    type: "primary",
    plain: true,
...
<template>
  <xy-button plain @click="openPlainMessage">打开 plain + 自定义图标</xy-button>
</template>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> openPlainMessage</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">() {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    message: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"这是一条更轻的 plain 风格消息。"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    plain: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF">true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    icon: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"mdi:palette-outline"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
