...
function openHtmlNotification() {
  XyNotificationService.open({
    title: "同步结果",
    dangerouslyUseHTMLString: true,
    duration: 0,
    message:
      "<strong>3 个任务成功</strong><br><span>1 个任务等待重试</span>"
  });
}
<\/script>
...
<template>
  <xy-space wrap>
    <xy-button type="primary" @click="openHtmlNotification">
      打开 HTML 通知
    </xy-button>
    <xy-tag round status="warning">仅限可信内容</xy-tag>
  </xy-space>
</template>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> openHtmlNotification</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">() {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    title: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"同步结果"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">      "&#x3C;strong>3 个任务成功&#x3C;/strong>&#x3C;br>&#x3C;span>1 个任务等待重试&#x3C;/span>"</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    &#x3C;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-tag</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> round</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> status</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"warning"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">>仅限可信内容&#x3C;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-tag</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">></span></span>
...
function openHtmlNotification() {
    XyNotificationService.open({
        ...
        dangerouslyUseHTMLString: true,
        duration: 0,
        message: "<strong>3 个任务成功</strong><br><span>1 个任务等待重试</span>"
    });
}
<\/script>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">        dangerouslyUseHTMLString: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF">true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">        duration: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF">0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">        message: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"&#x3C;strong>3 个任务成功&#x3C;/strong>&#x3C;br>&#x3C;span>1 个任务等待重试&#x3C;/span>"</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    });</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">}</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">&#x3C;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">script</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">></span></span>
<span class="line"></span>
