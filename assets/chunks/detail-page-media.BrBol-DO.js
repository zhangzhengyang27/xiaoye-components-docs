...
const sections = [
  ...
  },
  {
    key: "record",
    title: "沟通录音",
    description: "把 AudioPlayer 直接放进 DetailPage 的 section 中。"
  }
];
...
<template>
  <xy-detail-page
    title="售后工单详情"
    description="DetailPage 负责承接详情结构，AudioPlayer 放在业务 section 里承接录音回放。"
    :sections="sections"
  ...
  >
    <template #base>
      <xy-descriptions :column="2" border>
        <xy-descriptions-item label="工单编号">A-2048</xy-descriptions-item>
        <xy-descriptions-item label="客户">杭州云仓</xy-descriptions-item>
    ...
    <template #record>
      <div class="xy-doc-stack">
        ...
        />
        <xy-space wrap>
          <xy-tag status="warning">重点复核 18s-35s</xy-tag>
          <xy-tag status="primary">疑似承诺超时补发</xy-tag>
        </xy-space>
      </div>
    </template>
  </xy-detail-page>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    title: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"沟通录音"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    description: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"把 AudioPlayer 直接放进 DetailPage 的 section 中。"</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">];</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">  {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    id: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"transcript"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    name: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"通话转写记录.md"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    size: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"26 KB"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    title: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"提交录音复核"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    timestamp: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"2026-03-30 10:20"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">    title</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"售后工单详情"</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">    description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"DetailPage 负责承接详情结构，AudioPlayer 放在业务 section 里承接录音回放。"</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">        &#x3C;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-descriptions-item</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> label</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"工单编号"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">>A-2048&#x3C;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-descriptions-item</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">></span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">        &#x3C;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-descriptions-item</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> label</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"客户"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">>杭州云仓&#x3C;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-descriptions-item</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">></span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">            title: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">'售后回访录音'</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">            artist: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">'客服一组'</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">          &#x3C;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-tag</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> status</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"warning"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">>重点复核 18s-35s&#x3C;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-tag</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">></span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">          &#x3C;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-tag</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> status</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"primary"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">>疑似承诺超时补发&#x3C;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D">xy-tag</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">></span></span>
