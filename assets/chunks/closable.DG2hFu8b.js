...
function openPersistentMessage() {
  XyMessage({
    message: "这条消息不会自动关闭，适合承接明确的人工确认。",
    type: "warning",
    showClose: true,
    duration: 0
  });
...
<template>
  <xy-button type="primary" @click="openPersistentMessage"> 打开可手动关闭提示 </xy-button>
</template>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0"> openPersistentMessage</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">() {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    message: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">"这条消息不会自动关闭，适合承接明确的人工确认。"</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">,</span></span>
